...
| `installerUrl` | HTTPS URL beneath `https://github.com/Latesandwich/stratis-releases/releases/` for the verified Windows installer asset. |
| `sha256` | The installer's 64-character lowercase hexadecimal SHA-256. |
| `releaseNotesUrl` | HTTPS URL beneath `https://github.com/Latesandwich/stratis-releases/releases/` for that release's notes. |
